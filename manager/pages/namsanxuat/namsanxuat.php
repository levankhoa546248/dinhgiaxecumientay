    ...
    $(document).ready(function () {
        ...
        function danhsach() {
            ...
            $('#danhsach').DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: "manager.php?controller=namsanxuat&action=danhsach",
                    dataSrc: ''
                },
                columns: [
        ...
        $("#them").click(function (e) {
            ...
            if (checkIf(ten)){
                ...
                $.ajax({
                    url: "manager.php?controller=namsanxuat&action=them",
                    type: "POST",
                    data: {
                        ten: ten
                    },
        ...
        $("#sua").click(function (e) {
            ...
            if (checkIf(id)){
                ...
                $.ajax({
                    url: "manager.php?controller=namsanxuat&action=sua",
                    type: "POST",
                    data: {
                        id: id,
                        ten: ten
        ...
        $("#xoa").click(function (e) {
            ...
            if (checkIf(id)){
                ...
                $.ajax({
                    url: "manager.php?controller=namsanxuat&action=xoa",
                    type: "POST",
                    data: {
                        id: id
                    },
