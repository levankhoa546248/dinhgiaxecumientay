                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <img class="direct-chat-img" src="manager/dist/img/user1-128x128.jpg"
                                    ...
                                    <div class="direct-chat-msg right">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <img class="direct-chat-img" src="manager/dist/img/user3-128x128.jpg"
                                             alt="message user image">
                                        <!-- /.direct-chat-img -->
                                        <div class="direct-chat-text">
...
<!-- jQuery UI 1.11.4 -->
<script src="manager/plugins/jquery-ui/jquery-ui.min.js"></script>
...
<!-- ChartJS -->
<script src="manager/plugins/chart.js/Chart.min.js"></script>
<!-- Sparkline -->
<script src="manager/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="manager/plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="manager/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="manager/plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<!-- overlayScrollbars -->
<script src="manager/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
