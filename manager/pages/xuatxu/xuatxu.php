        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h3 class="card-title">Danh sách xuất xứ</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
    ...
    $(document).ready(function () {
        ...
        function danhsach() {
            ...
            $('#danhsach').DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: "manager.php?controller=xuatxu&action=danhsach",
                    dataSrc: ''
                },
                columns: [
        ...
        $("#them").click(function (e) {
            var ten = $("#ten").val();
            if (checkIf(ten)){
                toastr.error('Chưa nhập tên xuất xứ')
            }else {
                $.ajax({
                    url: "manager.php?controller=xuatxu&action=them",
                    type: "POST",
                    data: {
                        ten: ten
                    },
        ...
        $("#sua").click(function (e) {
            ...
            if (checkIf(id)){
                ...
                $.ajax({
                    url: "manager.php?controller=xuatxu&action=sua",
                    type: "POST",
                    data: {
                        id: id,
                        ten: ten
        ...
        $("#xoa").click(function (e) {
            ...
            if (checkIf(id)){
                ...
                $.ajax({
                    url: "manager.php?controller=xuatxu&action=xoa",
                    type: "POST",
                    data: {
                        id: id
                    },
