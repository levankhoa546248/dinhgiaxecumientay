    ...
    $(document).ready(function () {
        ...
        function danhsach() {
            ...
            $('#danhsach').DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: "manager.php?controller=chucvu&action=danhsach",
                    dataSrc: ''
                },
                columns: [
        ...
        $("#them").click(function (e) {
            var ten = $("#ten").val();
            if (checkIf(ten)){
                toastr.error('Chưa nhập tên chức vụ')
            }else {
                $.ajax({
                    url: "manager.php?controller=chucvu&action=them",
                    type: "POST",
                    data: {
                        ten: ten
                    },
        ...
        $("#sua").click(function (e) {
            ...
            if (checkIf(id)){
                ...
                $.ajax({
                    url: "manager.php?controller=chucvu&action=sua",
                    type: "POST",
                    data: {
                        id: id,
                        ten: ten
        ...
        $("#xoa").click(function (e) {
            ...
            if (checkIf(id)){
                ...
                $.ajax({
                    url: "manager.php?controller=chucvu&action=xoa",
                    type: "POST",
                    data: {
                        id: id
                    },
