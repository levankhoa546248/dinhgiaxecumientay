...
if (!empty($_FILES)) {
    ...
    $numimages = count(glob("car/images/giaydangkiem/" . "*")) + 1;
    $namefile = $_POST["fileId"];
    $file = $_FILES["file_data"];
    $nameimage = $idguiban . "_" . $numimages . "_" . $namefile;
    $config = array(
        'name' => $nameimage,
        'upload_path' => 'car/images/giaydangkiem/',
...
//    $file_path = $options['upload_path'] . $name;
    ...
    $fileid = $_POST["fileId"];
    $sqlInsert = "INSERT INTO ha_giaydangkiem (idguiban, duongdan, fileid) VALUES ($idguiban, '$file_path', '$fileid')";
