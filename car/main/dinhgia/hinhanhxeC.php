...
if (!empty($_FILES)) {
    ...
    $numimages = count(glob("car/images/hinhanhxe/" . "*")) + 1;
    $namefile = $_POST["fileId"];
    $file = $_FILES["file_data"];
    $nameimage = $idguiban . "_" . $numimages . "_" . $namefile;
    $config = array(
        'name' => $nameimage,
        'upload_path' => 'car/images/hinhanhxe/',
...
//    $file_path = $options['upload_path'] . $name;
    ...
    $fileid = $_POST["fileId"];
    $sqlInsert = "INSERT INTO hinhanhguibanxe (idguiban, duongdan) VALUES ($idguiban, '$file_path')";
